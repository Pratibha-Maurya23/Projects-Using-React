    ...
    <div id='pricing' className='bg-[#f7f8fc] pt-32'>
      ...
      className='container mx-auto px-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-l mb-12 md:w-2/3 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo quis accusamus est dolorum fugiat velit illum rs maiores a ullam?</p>
        </div>
        ...
        <div className='flex flex-col md:w-5/6 mx-auto md:flex-row gap-8 pb-12'>
        {
          packages.map((pkg, index) => (
            ...
            <p className='text-l mb-4'>{pkg.description}</p>
            <ul className='text-s list-disc list-inside space-y-2 mb-6'>
              {
