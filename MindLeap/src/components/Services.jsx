      ...
      <div className="pt-28 px-4 container mx-auto">
        ...
        className="text-center space-y-5">
          ...
          <p className="md:w-1/2 mx-auto">
            ...
            error. Veniam quo sequi vel reprehenderit veritatis neque culpa
            obcaecati tempora!
          </p>
        </motion.div>
        ...
        viewport={{once: false, amount:0.7}}
            className="flex flex-wrap justify-between items-center md:gap-8 gap-4">
              <Tab>Coupling Counseling</Tab>
              <Tab>Paranting Skill</Tab>
        ...
        viewport={{once: false, amount:0.7}}
              className="flex flex-col md:flex-row gap-8 mt-8">
                ...
                <p className="mb-8">
                  ...
                  Adipisci, dolore cum. Quas amet fuga quo. Quae temporibus
                  nihil neque placeat modi, libero corporis debitis. Voluptas!
                </p>
